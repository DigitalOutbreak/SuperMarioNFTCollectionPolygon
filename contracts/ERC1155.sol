...
contract ERC1155 {
    ...
    // transfers an amount of NFTs but first checks if the receiver is a smart contract. If it is a smart contract it checks to see if the smart contract has the onERC1155Received() function
    ...
    function _checkOnERC1155Received() private pure returns(bool) {
        //Oversimplified version, not rlly how it works
        return true;
    }
    ...
    // ERC165 Compliant
    // Tell everyone that we support the REC1155 function
